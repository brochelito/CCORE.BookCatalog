    ...
    public static class IdentityServiceExtensions
    {
        public static void AddIdentityServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddDbContext<BookCatalogIdentityDbContext>(options => options.UseSqlServer(configuration.GetConnectionString("BookCatalogIdentityConnectionString"),
                b => b.MigrationsAssembly(typeof(BookCatalogIdentityDbContext).Assembly.FullName)));

            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<BookCatalogIdentityDbContext>().AddDefaultTokenProviders();
